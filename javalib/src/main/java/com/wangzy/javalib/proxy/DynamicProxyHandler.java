...
public class DynamicProxyHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        System.out.println("我正在动态代理[" + object.getClass().getSimpleName() + "]的[" + method.getName() + "]方法");
    ...
    public static Object newProxyInstance(Object object) {
        ...
        return Proxy.newProxyInstance(object.getClass().getClassLoader(),object.getClass().getInterfaces(), new DynamicProxyHandler(object));
